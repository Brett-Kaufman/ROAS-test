...
export const CAPABILITIES = [
  ...
  "Create and deploy viral ad campaigns.",
  "Closing high-ticket deals at your events."
];

export const CASE_STUDIES: Testimonial[] = [
  {
    headline: "Scaling to $1.2M/mo without increasing ad spend.",
    brand: "VINCE DELMONTE",
  ...
  {
    headline: "Generating over $1,000,000 in sales by bridging the Sales-Marketing divide.",
    brand: "PETER SAGE",
  ...
  {
    headline: "Generating $24,000 in 90 minutes by fixing technical email deliverability.",
    brand: "BEN HARTMAN",
  ...
  {
    headline: "Building the 'Netflix' of olive oil content.",
    brand: "KASANDRINOS",
