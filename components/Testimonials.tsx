          ...
          {isYouTube && ytId ? (
            ...
            >
              ...
              <div className="absolute inset-0 z-40 flex items-center justify-center">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-blue-600/20 border border-blue-500/50 backdrop-blur-md flex items-center justify-center transition-all duration-700 group-hover/yt:scale-110 group-hover/yt:bg-blue-600/80 group-hover/yt:shadow-[0_0_60px_rgba(37,99,235,0.7)]">
