  ...
  return (
    <div className="w-full space-y-8 md:space-y-12">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[11px] md:text-sm font-black text-blue-400 uppercase tracking-[0.4em]">
                  {isPlaying ? 'STREAM ACTIVE' : 'CLICK HERE'}
                </span>
              </div>
            ...
            <div className="relative max-w-5xl">
              ...
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-3/4 h-[3px] bg-blue-600/40 group-hover:bg-blue-500 transition-all"></div>
            </div>
      ...
      <div className="relative w-full aspect-video overflow-hidden border border-white/10 bg-black shadow-[0_0_60px_rgba(0,102,255,0.15)] group rounded-sm">
        ...
        <div 
          className={`absolute inset-0 z-30 flex items-center justify-center bg-black/40 transition-all duration-700 ${isPlaying ? 'opacity-0 pointer-events-none scale-110' : 'opacity-100'}`}
          onClick={handleTogglePlay}
        >
          <button 
            className="w-20 h-20 md:w-32 md:h-32 rounded-full border border-blue-500/30 bg-blue-600/10 backdrop-blur-md flex items-center justify-center group/play transition-all duration-500 hover:scale-110 hover:border-blue-500 hover:bg-blue-600/20 shadow-[0_0_30px_rgba(37,99,235,0.2)] hover:shadow-[0_0_50px_rgba(37,99,235,0.4)]"
