...
const BookingSection: React.FC = () => {
   ...
   */
  const calendlyUrl = "https://calendly.com/brett-from-captivating/eda?hide_event_type_details=1&background_color=0d0d0d&text_color=d1d5db&primary_color=3b82f6";
